...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <table>
            ...
            <tr>
                <td> <button><a href="Velo/veloIndex.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Bicloo</a></button></td>
            </tr>
            <tr>
                <td> <button><a href="Marguerite/margueriteIndex.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Station marguerite</a></button></td>
            </tr>
