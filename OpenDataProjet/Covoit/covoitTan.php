...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <table>
            <tr>
                <td> <button style="background-color: white ; color: black;"><a href="covoitIndex.php"  class="w3-bar-item w3-button w3-hover-white">Tan</a></button></td>
            </tr>
            <tr>
            ...
            <tr>
                <td> <button style="background-color: white ; color: black;"><a href="../Tan/tanIndex.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Aire de covoiturage</a></button></td>
            </tr>
        </table>
    </div>
...
<div class="w3-main" style="margin-left:400px;margin-right:40px">
    ...
    <div class="w3-container" style="margin-top:20px" id="showcase">
        ...
        <img src="../image/covoitCircuits.png">
